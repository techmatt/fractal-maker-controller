...
- The old durability contract, tracked-bulk policy, weights retention, and every guard live on in maker's `docs/design/{storage_classes, artifacts_resolver}.md` + the controller git history — point there if archive surgery is ever needed. Its label corpora, tracked records, and PREVIOUS-rung weights are intact for migration pulls.
