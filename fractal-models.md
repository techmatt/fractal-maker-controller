...
| **wallpaper v3** | finished SMOOTH renders | advisory scoring + annotation (enforcement retired 2026-08-09); collapses strange ≈0.000, never gates them |
| **mining v1** | finished STRANGE renders, K=3 | advisory scoring + annotation (enforcement retired 2026-08-09) |
...
- Class-4 WATCH: v10's retired itself at the flip (census AUC(q4) 0.7273 → 0.7664); **`Q4_WATCH` is RETIRED AS STATED** — its object was the six calibrated t_good partitions, and they were deleted with the apparatus (`production_seeder.Q4_WATCH*` gone).
