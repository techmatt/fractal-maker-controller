...
- **★★ CHECKPOINT PROMPT NAMING (Matt, 2026-08-14): `distill_ckptXX.md` is ALWAYS the controller-CC apply prompt (mechanical); `continuation_ckptXX.md` is what a fresh claude.ai session receives alongside the ten docs.** The era-closing claude.ai session AUTHORS both — a fresh session is never asked to compose docs, and the applier CC refuses editorial prompts.
