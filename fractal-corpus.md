...
- Class-4 counts as of 2026-08-04: native mb3 **9** · mb4 **8** · mb5 **16**, +4 native / +5 phoenix / +26 parameter-plane from the v2 sitting. Mandelbrot: 0 class-4 ANYWHERE (0/526 unbiased; 0/39 sitting past class 2) ⇒ unbiased mandelbrot draws are overhead, and its uniform currency target moves only if it ever scores.
